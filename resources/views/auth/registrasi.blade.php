    ...
    <section id="#" class="py-24"
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="md:w-2/4 p-5 text-center md:text-left mb-8 md:mb-0 bg-opacity-50 bg-black rounded-lg">
                <h2 class="text-4xl font-bold mt-3 text-white"><span style="color: greenyellow">Kementerian Agama</span> Kota Banjarmasin</h2>
                <p class="my-7 mt-2 text-white">Bersih Melayani, Ikhlas Beramal</p>
                <form class="space-y-6" id="registrationForm" method="POST" action="{{ route('postregistrasi') }}" onsubmit="return validatePasswords()">
                    {{ csrf_field() }}
                    ...
                    <div>
                        <label for="password" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Masukkan Password</label>
                        <input type="password" name="password" id="password" placeholder="••••••••"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black"
                            required />
                    </div>
                    <div>
                        <label for="confirm_password" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Konfirmasi Password</label>
                    ...
                    <div class="text-sm font-medium text-gray-500 dark:text-white">
                        Sudah Memiliki Akun? <a href="{{ url('login') }}" class="hover:underline hover:text-primary">Login</a>
                    </div>
                </form>
            </div>
        </div>
