        ...
        <ul>
            ...
            <li>
                ...
                <ul class="">
                    ...
                    <li>
                        <a href="{{ route('cek-verifikasi') }}" class="side-menu side-menu--active">
                            <div class="side-menu__icon"> <i data-lucide="book"></i> </div>
                    ...
                    <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-40">
                                ...
                                <div class="flex items-center justify-center text-danger"> <i data-lucide="slash" class="w-4 h-4 mr-2"></i> Ditolak </div>
                                <div class="flex items-center justify-center text-primary"> <i data-lucide="loader" class="w-4 h-4 mr-2"></i> Proses </div>
                            </td>
                        </tr>
                    </tbody>
                </table>
