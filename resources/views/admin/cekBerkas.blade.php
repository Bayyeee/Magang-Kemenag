            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="{{ route('cekBerkas') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="folder"></i> </div>
                                    <div class="side-menu__title"> Cek Berkas </div>
                                </a>
                            </li>
                            <li>
                    ...
                    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                        <table class="table table-report -mt-2">
                            ...
                            <tbody>
                                <tr class="intro-x">
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">(nama file)</a>
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Jenis File</div>
                                    </td>
                                    <td class="text-center">1</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-success"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> Verifikasi </div>
                                        <div class="flex items-center justify-center text-primary"> <i data-lucide="square" class="w-4 h-4 mr-2"></i> Proses </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3 text-success" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Diverifikasi </a>
                                            <a class="flex items-center text-danger" href="javascript:;"> <i data-lucide="x-square" class="w-4 h-4 mr-1"></i> Ditolak </a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
