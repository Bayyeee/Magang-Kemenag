<section id="contact" class="bg-cover bg-no-repeat bg-center relative py-16 px-2">
    <div
            ...
            <form>
                <div class="space-y-4 mt-8">
                    ...
                    <input type="email" placeholder="Email"
                        class="px-2 py-3 bg-white text-gray-dark w-full text-sm border-b  outline-none" />
                    <textarea placeholder="Write Message" class="px-2 pt-3 bg-white text-gray-dark w-full text-sm border-b  outline-none"></textarea>
                </div>
                <button type="button"
        ...
        <div class="z-10 relative h-full max-md:min-h-[350px]">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.139730718215!2d114.58637807589466!3d-3.3156146412135494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de423c6c5eb243b%3A0x9280e569b62a092d!2sKantor%20Kementerian%20Agama%20Kota%20Banjarmasin!5e0!3m2!1sid!2sid!4v1715507765670!5m2!1sid!2sid"
